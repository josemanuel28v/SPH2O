...
void PCISPHBoundaryObject::addCube(Vector3r min, Vector3r max, bool inverted)
{
...
void PCISPHBoundaryObject::addSphere(Vector3r pos, Real radius, bool inverted)
{
    const uint currentBoundaryParticles = getSize();
    std::vector<Vector3r> points;
...
void PCISPHBoundaryObject::sampleCube(Vector3r min, Vector3r max, std::vector<Vector3r> & points, std::vector<Vector3r> & normals)
{
...
void PCISPHBoundaryObject::sampleSphere(Vector3r origen, Real radius, std::vector<Vector3r> & points)
{
    SPHSimulation* sim = SPHSimulation::getCurrent();
