...
#include "RegularTriangleSampling/RegularTriangleSampling.h"
...
void AkinciBoundaryObject::addCube(const Vector3r& min, const Vector3r& max)
{
...
void AkinciBoundaryObject::addSphere(const Vector3r& pos, const Real radius)
{
    const uint currentBoundaryParticles = getSize();
    std::vector<Vector3r> points;
...
void AkinciBoundaryObject::addGeometry(const std::string& path, const Real particleRadius)
{
    const uint currentBoundaryParticles = getSize();
    std::vector<Vector3r> points;
...
void AkinciBoundaryObject::sampleCube(const Vector3r& min, const Vector3r& max, std::vector<Vector3r>& points)
{
    SPHSimulation* sim = SPHSimulation::getCurrent();
...
void AkinciBoundaryObject::sampleSphere(const Vector3r& origen, const Real radius, std::vector<Vector3r>& points)
{
    SPHSimulation* sim = SPHSimulation::getCurrent();
...
void AkinciBoundaryObject::sampleGeometry(const std::string& path, const Real maxDistance, const Vector3r& scale, const Vector3r& translate, const Vector3r& rotate, std::vector<Vector3r> & points)
{
